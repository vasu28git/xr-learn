      ...
      <main className="relative z-10 w-full max-w-md px-6">
        <div className="glass-panel rounded-xl p-8 flex flex-col items-center">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="font-code-sm text-[10px] text-on-surface-variant tracking-wider uppercase">Create Developer Profile</p>
          </div>
          ...
          <form className="w-full space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label className="font-code-sm text-[11px] text-on-surface-variant block" htmlFor="fullName">Full Name</label>
              <div className="relative">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-[18px]">account_circle</span>
                <input 
            ...
            <button 
              ...
              disabled={loading}
            >
              <span>{loading ? 'Registering...' : 'Register Environment'}</span>
          ...
          <div className="mt-8 text-center">
            <p className="font-body-sm text-xs text-on-surface-variant">
              Already registered?{' '}
              <Link className="text-primary hover:text-primary-fixed font-semibold transition-colors" to="/login">
                Access System
              </Link>
            </p>
          </div>
